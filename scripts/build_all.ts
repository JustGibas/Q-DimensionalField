...
function buildFrontend() {
  return new Promise((resolve, reject) => {
    exec("cd apps/frontend && npm run build", (error, stdout, stderr) => {
      if (error) {
...
function buildSharedUI() {
  return new Promise((resolve, reject) => {
    exec("cd apps/shared-ui && npm run build", (error, stdout, stderr) => {
      if (error) {
...
function buildSharedUtils() {
  return new Promise((resolve, reject) => {
    exec("cd apps/shared-utils && npm run build", (error, stdout, stderr) => {
      if (error) {
