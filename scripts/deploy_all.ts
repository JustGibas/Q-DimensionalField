...
function deployFrontend() {
  return new Promise((resolve, reject) => {
    exec("cd apps/frontend && deno task deploy", (error, stdout, stderr) => {
      if (error) {
...
function deploySharedUI() {
  return new Promise((resolve, reject) => {
    exec("cd apps/shared-ui && deno task deploy", (error, stdout, stderr) => {
      if (error) {
...
function deploySharedUtils() {
  return new Promise((resolve, reject) => {
    exec("cd apps/shared-utils && deno task deploy", (error, stdout, stderr) => {
      if (error) {
